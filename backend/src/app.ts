...
function getMetadata(prov: ProviderDataEntry, groupNo: number) {
  return {
    stringAnnotations: [
      ...
      new Annotation(
        "totalWorkHours",
        mapValueForAnnotation(prov.totalWorkHours, "totalWorkHours"),
      ),
      new Annotation(
        "totalWorkHours24h",
    ...
    numericAnnotations: [
      ...
      new Annotation(
        "numberOfJobs",
        mapValueForNumberAnnotation(prov.numberOfJobs, "numberOfJobs"),
      ),
      new Annotation(
        "numberOfJobs24h",
        mapValueForNumberAnnotation(prov.numberOfJobs24h, "numberOfJobs24h"),
      ),
    ],
  };
}
